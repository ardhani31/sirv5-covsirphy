...
class SIRF(ModelBase):
    ...
    NAME = "SIR-F"
    # names of parameters
    PARAMETERS = ["theta", "kappa", "rho", "sigma", "vacrate"]
    DAY_PARAMETERS = [
    ...
    VARS_INCLEASE = [ModelBase.R, ModelBase.V]
    ...
    EXAMPLE = {
        ...
        ModelBase.Y0_DICT: {
            ModelBase.S: 999_000, ModelBase.CI: 1000, ModelBase.R: 0, ModelBase.V: 0,
        },
    }
    ...
    def __call__(self, t, X):
        ...
        n = self.population
        s, i, *_ = X
        dsdt = 0 - self.rho * s * i / n + (0 - self.vacrate)
        drdt = self.sigma * i
        dvdt = self.vacrate
    ...
    def param_range(cls, taufree_df, population, quantiles=(0.1, 0.9)):
        ...
        s, i, r, f = df[cls.S], df[cls.CI], df[cls.R], df[cls.V]
        ...
        _dict = {
            ...
            in zip(["kappa", "rho", "sigma", "vacrate"], [kappa_series, rho_series, sigma_series])
        }
        _dict["theta"] = (0.0, 1.0)
        return _dict
    ...
    def restore(cls, specialized_df):
        ...
        df[cls.C] = df[cls.CI] + df[cls.R] + df[cls.V]
    ...
    def convert(cls, data, tau):
        ...
        return df.loc[:, [cls.S, cls.CI, cls.R, cls.V]]
    ...
    def convert_reverse(cls, converted_df, start, tau):
        ...
        # Conversion of variables: un-necessary for SIR-F model
        return df.loc[:, [cls.DATE, cls.S, cls.CI, cls.V, cls.R]]
    ...
    def guess(cls, data, tau, q=0.5):
        ...
        df = df.loc[(df[cls.S] > 0) & (df[cls.CI] > 0)]
        n = df.loc[df.index[0], [cls.S, cls.CI, cls.V, cls.R]].sum()
